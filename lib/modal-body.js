...
ModalBody.prototype.createForm = function () {
  this.target.innerHTML = `<div class="form-container"><div>Name: </div><input id="name" type="text" placeholder="" class="form-control" /><div>`
}
